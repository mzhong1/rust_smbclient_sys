...
pub type smbc_open_fn = option::Option<
    extern "C" fn(c: *mut SMBCCTX, fname: *const c_char, flags: c_int, mode: mode_t)
        -> *mut SMBCFILE,
>;
...
pub type smbc_write_fn = option::Option<
    extern "C" fn(c: *mut SMBCCTX, file: *mut SMBCFILE, buf: *const c_void, count: size_t)
        -> ssize_t,
>;
...
>;
pub type smbc_stat_fn = option::Option<
    extern "C" fn(c: *mut SMBCCTX, fname: *const c_char, st: *mut FileStat) -> c_int,
>;
pub type smbc_fstat_fn =
    option::Option<extern "C" fn(c: *mut SMBCCTX, file: *mut SMBCFILE, st: *mut FileStat) -> c_int>;
...
pub type smbc_getdents_fn = option::Option<
    extern "C" fn(c: *mut SMBCCTX, dir: *mut SMBCFILE, dirp: *mut smbc_dirent, count: c_int)
        -> c_int,
>;
...
pub type smbc_fstatdir_fn =
    option::Option<extern "C" fn(c: *mut SMBCCTX, dir: *mut SMBCFILE, st: *mut FileStat) -> c_int>;
...
pub type smbc_listxattr_fn = option::Option<
    extern "C" fn(context: *mut SMBCCTX, fname: *const c_char, list: *mut c_char, size: size_t)
        -> c_int,
>;
...
extern "C" {
    ...
    pub fn smbc_stat(url: *const c_char, st: *mut FileStat) -> c_int;
    pub fn smbc_fstat(fd: c_int, st: *mut FileStat) -> c_int;
    ...
    pub fn smbc_thread_impl(
        ...
        create_tls: ::std::option::Option<
            extern "C" fn(keyname: *const c_char, ppkey: *mut *mut c_void, location: *const c_char)
                -> c_int,
        >,
